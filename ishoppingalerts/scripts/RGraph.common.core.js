...
var size = obj.Get('chart.text.size');var font = obj.Get('chart.text.font');var angle = 270;var yaxis_title_pos = obj.Get('chart.title.yaxis.pos');if(obj.Get('chart.title.yaxis.align') == 'right' || obj.Get('chart.title.yaxis.position') == 'right'){
...
var px = obj.coordsKey[i][0];var py = obj.coordsKey[i][1];var pw = obj.coordsKey[i][2];var ph = obj.coordsKey[i][3];if(   mouseX > px && mouseX < (px + pw) && mouseY > py && mouseY < (py + ph) ){
var index = obj.coordsKey.length - i - 1;context.beginPath();context.fillStyle = 'rgba(255,255,255,0.9)';context.fillRect(obj.Get('chart.gutter.left'),obj.Get('chart.gutter.top'),canvas.width - obj.Get('chart.gutter.left') - obj.Get('chart.gutter.right'),canvas.height - obj.Get('chart.gutter.top') - obj.Get('chart.gutter.bottom'));context.fill();context.beginPath();context.strokeStyle = obj.Get('chart.colors')[index];context.lineWidth = obj.Get('chart.linewidth');for (var j=0; j<obj.coords2[index].length; ++j){
